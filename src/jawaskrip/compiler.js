        ...
        while (i < _code.length) {
            ...
            if (c == "\n") {
                ...
                if (handler.includes(word) && !lastTokenIsKeyword) {
                    ...
                    tokens.push(
                        this.toke(constant.T_MINUS, symbol.MINUS, line)
                    );
                else if (word == "dikali")
                    tokens.push(
                        this.toke(constant.T_TIMES, symbol.TIMES, line)
                    );
                else if (word == "dibagi")
                    tokens.push(
                    ...
                    tokens.push(this.toke(constant.T_VARNAME, word, line));
            } else if (c == "/" && _code[i + 1] == "/") {
                // comment
                let comment = "";
                while (_code[i] != "\n") {
                ...
                tokens.push(this.toke(constant.T_COMMA, c, line));
            else if (c == ":")
                tokens.push(this.toke(constant.T_COLON, c, line));
            else if (c == ";")
